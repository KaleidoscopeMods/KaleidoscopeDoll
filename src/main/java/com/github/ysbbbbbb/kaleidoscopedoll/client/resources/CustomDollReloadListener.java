...
public class CustomDollReloadListener implements ResourceManagerReloadListener {
    ...
    public static final ResourceLocation DEFAULT_TEXTURE_ID = ResourceLocation.fromNamespaceAndPath(KaleidoscopeDoll.MOD_ID, "textures/block/default_custom_doll.png");
    ...
    private static void readDefaultModel(ResourceManager manager) {
        manager.getResource(ResourceLocation.fromNamespaceAndPath(KaleidoscopeDoll.MOD_ID, "models/bedrock/default_custom_doll.json")).ifPresent(res -> {
