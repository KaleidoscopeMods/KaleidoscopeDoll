...
public final class ModItems {
    ...
    public static void registerItems() {
        ...
        Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(KaleidoscopeDoll.MOD_ID, "doll_icon"), DOLL_ICON);
        Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(KaleidoscopeDoll.MOD_ID, "doll_entity_item"), DOLL_ENTITY_ITEM);
    }
}
