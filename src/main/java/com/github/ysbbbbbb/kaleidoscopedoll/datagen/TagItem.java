...
public class TagItem extends ItemTagsProvider {
    public static final TagKey<Item> DOLL_MACHINE_TOKENS = TagKey.create(Registries.ITEM, new ResourceLocation(KaleidoscopeDoll.MOD_ID, "doll_machine_tokens"));
    public static final TagKey<Item> VANILLA_DOLLS = TagKey.create(Registries.ITEM, new ResourceLocation(KaleidoscopeDoll.MOD_ID, "vanilla_dolls"));
    public static final TagKey<Item> ALL_DOLLS = TagKey.create(Registries.ITEM, new ResourceLocation(KaleidoscopeDoll.MOD_ID, "all_dolls"));
